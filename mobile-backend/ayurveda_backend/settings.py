...
ROOT_URLCONF = 'ayurveda_backend.urls'
...
WSGI_APPLICATION = 'ayurveda_backend.wsgi.application'

# Database
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql',
        'NAME': config('DB_NAME', default='ayurveda_db'),
...
AWS_STORAGE_BUCKET_NAME = config('AWS_STORAGE_BUCKET_NAME', default='ayurveda-videos')
...
# DRM Configuration
VDOCIPHER_API_SECRET = config('VDOCIPHER_API_SECRET', default='')
...
DEVICE_POLICY = config('DEVICE_POLICY', default='deactivate_previous')  # or 'block_new'
