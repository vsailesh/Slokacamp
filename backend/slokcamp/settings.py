...
ALLOWED_HOSTS = os.getenv('ALLOWED_HOSTS', 'localhost,127.0.0.1,ayurlearn.preview.emergentagent.com,*.preview.emergentagent.com').split(',')
...
# Celery Configuration (disabled - enable when Redis is running)
...
CORS_ALLOWED_ORIGINS = os.getenv('CORS_ORIGINS', 'http://localhost:3000,https://ayurlearn.preview.emergentagent.com').split(',')
